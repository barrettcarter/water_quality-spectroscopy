...
#%% Make Streams boxplots for Chapter 2

test_rmses_path = os.path.join(streams_output_dir,'performance metrics', 'Streams_test_rmse.csv')
test_rsqs_path = os.path.join(streams_output_dir,'performance metrics', 'Streams_test_rsq.csv')
...
factor_letters_fn = f'{abbrv}_rsq-rmse_Tukey-by-sp_factor-letters.csv'
...
factor_letters_fn = f'{abbrv}_rsq-rmse_Tukey-by-mod_factor-letters.csv'
