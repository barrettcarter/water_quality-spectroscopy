...
def calc_abs(sample_array,reference_array,baseline_corr = False, 
    ...
    if baseline_corr == False:
        ...
        sample_array = sample_array - min(sample_array)
        reference_array = reference_array - min(reference_array)
        absorbance = np.log10(reference_array/sample_array)
...
### make plots
plt.figure()
plt.plot(waveLengths[0:300],abs_1[0:300],label = 'hat unfiltered')
plt.plot(waveLengths[0:300],abs_2[0:300],label = 'posnw16 unfiltered')
...
plt.figure()
plt.plot(waveLengths[0:300],abs_1_corr[0:300],label = 'hat unfiltered')
plt.plot(waveLengths[0:300],abs_2_corr[0:300],label = 'posnw16 unfiltered')
plt.ylim(0,1.75)
...
plt.figure()
plt.plot(waveLengths,sample1,label = 'hat unfiltered')
plt.plot(waveLengths,sample2,label = 'posnw16 unfiltered')
